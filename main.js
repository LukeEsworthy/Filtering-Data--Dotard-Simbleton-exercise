...
// Using FILTER function to return all New York businesses
...
// Using FILTER function to return all manufacturing industry businesses
...
//   outEl.innerHTML += `<h2>${agent[0].nameFirst} ${agent[0].nameLast}</h2>
//   <section>${agent[1]}</section>
//   <section>${agent[2]}</section>`;
//   outEl.innerHTML += `<hr/>`;
// });
